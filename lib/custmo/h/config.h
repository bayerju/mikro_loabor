...
// FBS
#pragma config BWRP =                                                          \
    WRPROTECT_OFF // Boot Segment Write Protect (Boot Segment may be written)
...
#pragma config GSS = OFF // General Segment Code Protection (User program memory
                         // is not code-protected)

// FOSCSEL
#pragma config FNOSC = PRI // Oscillator Mode (Primary Oscillator (XT, HS, EC))
#pragma config IESO = OFF // Internal External Switch Over Mode (Start-up device
